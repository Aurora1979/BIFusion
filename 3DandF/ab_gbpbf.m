...
path3=['D:\360MoveData\Users\LKOII\Desktop\3_ALL\result2\dmap_ssim\IR_',num2str(index),'.png'];
%% input images
...
%% Fusion
tic
F=fusion14m(im1,im2,im3,index);
%F = fusion1(im1,im2,im3);
%F=lp_fuse_ir1(im1,im2,im3);
toc

%%
dir1='D:\360MoveData\Users\LKOII\Desktop\3_ALL\result2\dmap_ssim\AB_GBP\';
